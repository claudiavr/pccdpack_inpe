...
procedure ordem_inpe (file_in, file_out)
...
bool   pripar=no      {prompt="include only first pair?"}
 
int		npar=0		  {prompt="Ignorar"}
struct *flist1         

begin
      int  id1, id2, imax , id[30000]
#      int  npar = 0
#	  npar = 0
      int  i = 0
      int  j = 0
      real xc[30000], yc[30000], mag[30000]
