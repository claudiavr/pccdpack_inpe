...
begin
  ...
  unlearn apphot.center
  apphot.center.image = imgrefer
  apphot.center.coords = temp0
  apphot.center.interactive = no
  temp1 = mktemp("tmp$ref")
  apphot.center.output = temp1
  apphot.center.verify = no
  apphot.center(imgrefer) 
