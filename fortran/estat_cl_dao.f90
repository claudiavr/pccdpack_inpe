...
real somaceu,somapsf, somadifx,somadify, somadesvx, somadesvy, somadifmag, somasigma
...
write(*,*)"Diferenca em x  Diferenca em y    erro em x       erro em y     erro em magnitudes"
write(*,*)2*somadifx/cont,2*somadify/cont,errox,erroy,2*somadifmag/cont
write(*,*)"Media do ceu   Sigma do ceu       Psf"
write(*,*)somaceu/cont,somasigma/cont,somapsf/cont

open(unit=file_out,file="estat.log")
write(file_out,*)"Diferenca em x  Diferenca em y    erro em x       erro em y     erro em magnitudes"
write(file_out,*)2*somadifx/cont,2*somadify/cont,errox,erroy,2*somadifmag/cont
write(file_out,*)"Media do ceu   Sigma do ceu       Psf"
write(file_out,*)somaceu/cont,somasigma/cont,somapsf/cont
close(file_out)
