...
c
	  ...
	  dimension ano(4000,16,20), ane(4000,16,20), skyo(4000,16),skye(4000,16)
	  dimension ap(20), areao(4000,16,20), areae(4000,16,20), a(8000)
...
c	  print*, norm
	  ...
	  print*, '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$'
	  print*, '$$$$$$$$$$$$$$ pccd4000gen14.f VERSION Jul/2014 $$$$$$$$$$$$$$'
	  print*, '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$'
c
...
c
			read(line(index(line,' '):),*,end=10) (a(l),
     $							l=1,3+3*nap)
            goto 20
...
c
	    do i=1,16
		  if (nim.eq.2) then
	            z1(i) = (ane1(i) - ano1(i))/(ane1(i) + ano1(i))
                else
                z1(i) = -(ano1(i)/an - 1.)
          end if
	  end do
      ...
      if (typewave.eq.2) then
	     if (norm.eq.1) then
	     	if (first) then
	     	   ...
	     	   print*, sumr2,sumr2_ant,abs(sumr2_ant-sumr2)/sumr2
c	     	   stop
	     	   if ((abs(sumr2_ant-sumr2)/sumr2).le.0.1) nao_convergiu=.false.
	     	   sumr2_ant=sumr2
	        end if
	        else
	  	    nao_convergiu=.false.
