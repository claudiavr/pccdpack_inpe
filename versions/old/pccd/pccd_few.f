...
c       Numero de estrelas=150    *    06 Jun 95    *    VEM - CVR
c
...
c
	...
	dimension ano(150,64,18), ane(150,64,18), skyo(150,64), skye(150,64)
	dimension ap(18), areao(150,64,18), areae(150,64,18), a(60)
	dimension sko(64), ske(64), ao(64), ae(64), areo(64), aree(64)
	dimension z(64),areaso(150,64),arease(150,64)
        integer nimages
