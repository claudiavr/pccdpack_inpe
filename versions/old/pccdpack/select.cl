...
# Colocado o corte em sigmax. Erro maximo na polarizacao.
################################################
...
begin
 ...
 struct line2
 string aa,bb,cc,dd,ee,ff,gg,hh,ii,jj,kk,ll, tmp, file_sel
 bool   stargood = yes
 real   rms = 0
 real   npts = 0
 real   cent1 = 0
 ...
 if (access(sel_file)) delete (sel_file,ver-)
 ...
 for (j = 1; j < nstars ; j = j + 1) {
	 ...
	 if (ivdata == yes)
         ...
         # print(xcenter,xcenter1,ycenter,ycenter1,id,id1)
         if (starelim != " ") {
