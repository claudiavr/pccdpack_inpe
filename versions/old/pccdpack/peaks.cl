...
string infile="imalignlist" {prompt="imalign output files (@)"}
string prefix="flsky"       {prompt="prefix images"}
string parval="max"         {prompt="parameter to analyse?"}
bool   outfile=yes          {prompt="create log?"}
...
imstat(imagem//"["//xmin//":"//xmax//","//ymin//":"//ymax//"]",fields="image,"//parval,>> temp1)
                 }
