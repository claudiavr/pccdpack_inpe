c corre?ao:"do's" DEVEM ir ate 16 (nao ate n_used). AAPQ 10-11-2009
c
c Incluidas mudancas da Claudia (listadas abaixo). AAPQ 27-10-2009
c
c **************************************************
...
c *** 24-10-2009
c A subrotina polar tinha alguns "do's" que usavam 16 e nao n_used. Modifiquei.
c *** 26-10-2009
...
c
	...
	dimension ano(4000,16,10), ane(4000,16,10), skyo(4000,16), skye(4000,16)
	dimension ap(10), areao(4000,16,10), areae(4000,16,10), a(8000)
	dimension sko(16), ske(16), ao(16), ae(16), areo(16), aree(16)
	dimension z(16),areaso(4000,16),arease(4000,16)
        integer nimages
...
c
	...
	print*, '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$'
	print*, '$$$$$$$$$$$ pccd4000gen09.f VERSION 10/11/2009 $$$$$$$$$$$$$'
	print*, '$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$'
c
...
4000	format(f10.6,f10.6,2f10.6,2f10.6,f8.2,f10.6,f14.7)
