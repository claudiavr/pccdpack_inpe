...
# August 2015 - CVR
#
# Included the check of the number of lines of the log file
#
#################


procedure macrol_inpe 
...
begin
     ...
     if (access(file_out//".out")) delete(file_out//".out",ver-)
...
#    print(nlines)
    ...
    delete(dum2,ver-)
     ...
     print("The number of lines in the log file is too few.")
     print("Check log file.")
     print("")
     erro=yes
	 if (erro == yes) {
	    	error (1," Error in macrol_inpe execution.")
 	 }
     }
#####
# 
